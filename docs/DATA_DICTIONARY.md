...
| `ip_country` | category | ISO country code | 20 fixed countries | conditional-on-fraud | = billing_country with p=0.93 base / 0.80 fraud, else a different country | Legit traffic mostly matches home country; fraud has higher (but not certain) mismatch odds since VPNs let fraud spoof location too. | 0.0049 (Cramér's V) |
